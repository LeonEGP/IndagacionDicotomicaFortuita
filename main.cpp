...
int main() {  //Complejidad Computacional: O(1). Dentro de esa ejecución lineal, se ejecuta un algoritmo de Ordenamiento para el Vector de Datos (Ya que es vital que los datos estén ordenados para la Búsqueda Binaria Aleatorizada), de Complejidad Computacional: O(n log n), siendo n la cantidad de datos en el vector. Así mismo, el realizar la búsqueda binaria aleatorizada tiene una Complejidad Computacional: O(log n), siendo n la cantidad de datos en el vector. 
